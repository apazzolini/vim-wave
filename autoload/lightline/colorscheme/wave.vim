" =============================================================================
" Filename: autoload/lightline/colorscheme/wave.vim
...
let s:p.normal.left = [ [ s:black, s:blue ], [ s:base05, s:base02 ] ]
...
let s:p.insert.left = [ [ s:base03, s:green ], [ s:base04, s:base02 ] ]
