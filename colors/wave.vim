...
call s:HL('MatchParen', g:wRed, g:wNoBg)
...
call s:HL('CursorLine', g:wBg2, g:wNoCterm)
call s:HL('Cursor', g:wNoCterm, g:wRedBg, g:wBlack)
call s:HL('Todo', g:wRedBg, g:wFg1)
...
" Neomake
call s:HL('NeomakeError', g:wNoBg, g:wRed, g:wNoCterm)
